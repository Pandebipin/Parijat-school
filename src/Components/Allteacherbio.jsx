...
const TeacherBio = () => {
  ...
  return (
    <div className="flex flex-col lg:flex-row gap-4 w-full mt-18 lg:mt-9 pt-4 lg:pt-12">
      <div className="w-full lg:w-1/3 mt-7 lg:block flex-shrink-0">
        <Sidebar />
      </div>
      ...
      <div className="p-4 bg-gray-100 w-full min-h-screen">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 gap-4 mt-7 md:gap-6">
