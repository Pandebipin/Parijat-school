      ...
      <div className="page mt-24">
        <div className="flex section-data justify-around p-6 flex-col md:flex-row gap-4 z-0">
         <div className="flex flex-col">
           <h1 className="text-black text-xl mt-2 md:text-2xl font-sans font-bold">{t("greetings11")}</h1>
            <span className="text-sm w-[400px] py-4 md:text-lg">{line12}</span>
      ...
      <div className="page2 z-9 flex flex-col flex-wrap p-5 pt-8 mt-9 bg-[#FFFFFF]">
        ...
        <div className="flex justify-center items-center w-full">
          <ScrollTrigger onEnter={() => setParaOn(true)} onExit={() => setParaOn(false)}>
            {paraOn && (
              <h1 className="para text-sm md:text-lg lg:text-xl font-md text-center text-gray-700">
                {line1}
              </h1>
            )}
          </ScrollTrigger>
